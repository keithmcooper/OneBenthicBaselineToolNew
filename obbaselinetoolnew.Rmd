...
## Add selected PIZ/SIZ
         ...
         addPolygons(data=siz[siz$area_numbe == input$siteInput, ],color = "#444444", fill = FALSE,weight = 1.5, smoothFactor = 0.5,group = "selected",popup = paste0("<b>Name: </b>", siz[siz$area_numbe == input$siteInput, ]$area_name, "<br>","<b>Number: </b>", siz[siz$area_numbe == input$siteInput, ]$area_numbe))%>%
...
p <- ggplot(data=selected_data3(), aes(x=factor(Assemblages), y=n, fill=factor(Assemblages))) +
 ...
 facet_wrap(~factor(name,levels=level_order2()),scales="free")+#
  theme(legend.position = "none",
        plot.margin = margin(0.4, 0, 0.5,0, "cm"),#margin(t = 0, r = 0, b = 0, l = 0, unit = "pt")
