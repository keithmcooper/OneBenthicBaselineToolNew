...
#assemblages<- raster("C:/Users/kmc00/OneDrive - CEFAS/R_PROJECTS/OneBenthicBiodiversityLayersApp/R/www/Assemblages.tif")
...
leaflet() %>% 
    ...
    addRasterImage(assemblages,col=assemcol,opacity = 1,project = 3857,group = "Assemblages")%>%
    addRasterImage(r_agg_region,col=pal2,opacity = 1,project = 3857,group = "Region")%>%
     addRasterImage(r_agg_siz,col=pal2,opacity = 1,project = 3857,group = "Footprint")%>%
    addRasterImage(r_uk_eez,col=pal2,opacity = 1,project = 3857,group = "EEZ")%>%
    ######################
  addLayersControl(
    overlayGroups = c("All (fauna)","All (phy)","Assemblages","euowf","owf","owf_cab","R4_chara","R4_bid","agg (PIZ)","agg (SIZ)","agg (REF)","disp","wave","tidal","tidal_cab","oga","mcz","sac","ncmpa","Assemblages","EEZ","Region","Footprint"),options = layersControlOptions(collapsed = FALSE))%>%#"wave_cab",
    hideGroup(c("All (fauna)","All (phy)","Assemblages","euowf","owf","owf_cab","R4_chara","R4_bid","agg (PIZ)","agg (SIZ)","agg (REF)","disp","wave","tidal","tidal_cab","oga","mcz","sac","ncmpa","Assemblages","EEZ","Region","Footprint"))%>%
...
## Add selected PIZ/SIZ
    ...
    addLayersControl(
    overlayGroups = c("Selected (fauna)","Selected (phy)","All (fauna)","All (phy)","euowf","owf","owf_cab","R4_chara","R4_bid","agg (PIZ)","agg (SIZ)","agg (REF)","disp","wave","tidal","tidal_cab","oga","mcz","sac","ncmpa","Assemblages","EEZ","Region","Footprint"),options = layersControlOptions(collapsed = FALSE))%>%#"wave_cab",
    hideGroup(c("Selected (phy)","All (fauna)","All (phy)","euowf","owf","owf_cab","R4_chara","R4_bid","agg (PIZ)","agg (SIZ)","agg (REF)","disp","wave","tidal","tidal_cab","oga","mcz","sac","ncmpa","Assemblages","EEZ","Region","Footprint"))#
#######################
#       addLayersControl(
#    overlayGroups = c("Region","Footprint"),options = layersControlOptions(collapsed = FALSE))%>%#"wave_cab",
# hideGroup(c("Region","Footprint"))#
...
library(terra)
r <- rast("C:/Users/kmc00/OneDrive - CEFAS/R_PROJECTS/OneBenthicBiodiversityLayersApp/R/www/Assemblages.tif")
#r <- round(r/100)
...
#head(raster_extent3)
raster_extent3$name <- 'Assemblages'
...
agg_siz_hum_comb$name <- 'Footprint (Humber)'# add in missing cols
agg_siz_hum_comb$id <- 'Footprint (Humber)'# add in missing cols
...
agg_siz_ang_comb$name <- 'Footprint (Anglian)'# add in missing cols
agg_siz_ang_comb$id <- 'Footprint (Anglian)'# add in missing cols
...
agg_siz_t_comb$name <- 'Footprint (Thames)'# add in missing cols
agg_siz_t_comb$id <- 'Footprint (Thames)'# add in missing cols
...
#plot(agg_siz_sc_comb)
agg_siz_sc_comb$name <- 'Footprint (South Coast)'# add in missing cols
agg_siz_sc_comb$id <- 'Footprint (South Coast)'# add in missing cols
...
#plot(agg_siz_sc_comb)
agg_siz_ec_comb$name <- 'Footprint (East Channel)'# add in missing cols
agg_siz_ec_comb$id <- 'Footprint (East Channel)'# add in missing cols
...
#plot(agg_siz_sc_comb)
agg_siz_nw457_comb$name <- 'Footprint (NW 457)'# add in missing cols
agg_siz_nw457_comb$id <- 'Footprint (NW 457)'# add in missing cols
...
#plot(agg_siz_sc_comb)
agg_siz_bc531_comb$name <- 'Footprint (BC 531)'# add in missing cols
agg_siz_bc531_comb$id <- 'Footprint (BC 531)'# add in missing cols
...
#plot(agg_siz_sc_comb)
agg_siz_bc476_comb$name <- 'Footprint (BC 476)'# add in missing cols
agg_siz_bc476_comb$id <- 'Footprint (BC 476)'# add in missing cols
...
#plot(agg_siz_sc_comb)
agg_siz_bc526_comb$name <- 'Footprint (BC 526)'# add in missing cols
agg_siz_bc526_comb$id <- 'Footprint (BC 526)'# add in missing cols
...
#plot(agg_siz_sc_comb)
agg_siz_gws_comb$name <- 'Footprint (Goodwin Sands)'# add in missing cols
agg_siz_gws_comb$id <- 'Footprint (Goodwin Sands)'# add in missing cols
...
#plot(agg_siz_sc_comb)
agg_siz_hs_comb$name <- 'Footprint (Hilbre Swash)'# add in missing cols
agg_siz_hs_comb$id <- 'Footprint (Hilbre Swash)'# add in missing cols
...
#plot(agg_siz_sc_comb)
agg_siz_bc472_comb$name <- 'Footprint (BC 472)'# add in missing cols
agg_siz_bc472_comb$id <- 'Footprint (BC 472)'# add in missing cols
...
#plot(agg_siz_sc_comb)
agg_siz_bc455_comb$name <- 'Footprint (BC 455/459/Bedwyn)'# add in missing cols
agg_siz_bc455_comb$id <- 'Footprint (BC 455/459/Bedwyn)'# add in missing cols
...
selected_data <- merge_test[which(merge_test$name=='Assemblages'|
                                    merge_test$name=='EEZ'|
...
level_order <- c('Assemblages',
                 'EEZ',
                 unique(agg_region$name),
                 'Footprint (Anglian)',
                 'Footprint (Humber)' ,
                 'Footprint (Thames)' ,
                 'Footprint (South Coast)' ,
                 'Footprint (East Channel)' ,
                 'Footprint (BC 531)' ,
                 'Footprint (BC 476)' ,
                 'Footprint (Goodwin Sands)' ,
                 'Footprint (Hilbre Swash)' ,
                 'Footprint (NW 457)' ,
                 'Footprint (BC 526)' ,
                 'Footprint (BC 472)' ,
                 'Footprint (BC 455/459/Bedwyn)' ,
