...
leaflet() %>% 
    ...
    ######################
  addLayersControl(
    overlayGroups = c("All (fauna)","All (phy)","Assemblages","euowf","owf","owf_cab","R4_chara","R4_bid","agg (PIZ)","agg (SIZ)","agg (REF)","disp","wave","tidal","tidal_cab","oga","mcz","sac","ncmpa","Assemblages (All)","Assemblages (EEZ)","Assemblages (RSMP Region)"),options = layersControlOptions(collapsed = FALSE))%>%#"wave_cab",,"Assemblages (Footprint)"
...
## Add selected PIZ/SIZ
    ...
    addLayersControl(
    overlayGroups = c("Selected (fauna)","Selected (phy)","All (fauna)","All (phy)","euowf","owf","owf_cab","R4_chara","R4_bid","agg (PIZ)","agg (SIZ)","agg (REF)","disp","wave","tidal","tidal_cab","oga","mcz","sac","ncmpa","Assemblages (All)","Assemblages (EEZ)","Assemblages (RSMP Region)"),options = layersControlOptions(collapsed = FALSE))%>%#,"Assemblages (Footprint)"
...
#br() 
p("Plots should be viewed together with the relevant associated map layers: Assemblages (All), Assemblages (EEZ) and Assemblages (RSMP Region). These layers can be toggled on/off in the map window. To visulaise the asseblages present within regional footprints simply toggle on the 'agg (SIZ)' map layer. Note the faunal identity of individual samples (map layers: 'selected (fauna)' and 'All (fauna)') may sometimes differ to that of the underlying model. This is expected and consistent with the notion that all models are imperfect.")
