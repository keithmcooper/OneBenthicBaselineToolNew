...
#plot(agg_siz_sc_comb)
agg_siz_nw457_comb$name <- 'EC Footprint'# add in missing cols
agg_siz_nw457_comb$id <- 'EC Footprint'# add in missing cols
...
#plot(agg_siz_sc_comb)
agg_siz_bc531_comb$name <- 'EC Footprint'# add in missing cols
agg_siz_bc531_comb$id <- 'EC Footprint'# add in missing cols
...
all_poly <- rbind(raster_extent3,uk_eez3,agg_region,agg_siz3,agg_siz_hum_comb2,agg_siz_sc_comb2,agg_siz_ang_comb2, agg_siz_t_comb2,agg_siz_ec_comb2,agg_siz_nw457_comb2, agg_siz_bc531_comb2 )
#head(all_poly)
#plot(all_poly)
#all_poly <- poly
...
level_order <- c('NW Europe','UK EEZ',unique(agg_region$name),'A Footprint','H Footprint' ,unique(agg_siz$area_numbe))
return(level_order)
})
